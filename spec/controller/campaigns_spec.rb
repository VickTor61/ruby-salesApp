...
# rubocop:todo RSpec/FilePath
RSpec.describe CampaignsController, type: :controller do # rubocop:todo RSpec/FilePath
  # rubocop:enable RSpec/FilePath
  describe '#index' do
    let(:user) { create :user, email: 'newmail@gmail.com' }
    let(:campaign) do
      create :campaign, name: 'second', message: 'second campaign created', user: user
    end

    before do
      @request.env['devise.mapping'] = Devise.mappings[user] # rubocop:todo RSpec/InstanceVariable
      sign_in user
